...
public class ClienteDAO extends JdbcDAO<Cliente> {
    ...
    @Override public Boolean atualizar(Cliente cliente) {
    ...
    @Override public Boolean deletar(Cliente cliente) {
    ...
    @Override public Cliente obter(Long codigo) {
    ...
    @Override public List<Cliente> listarTodos() {
