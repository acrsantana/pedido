...
public class PedidoDAO extends JdbcDAO<Pedido> {
    ...
    @Override public Boolean salvar(Pedido obj) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override public Boolean atualizar(Pedido obj) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override public Boolean deletar(Pedido obj) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override public Pedido obter(Long codigo) {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    @Override public List<Pedido> listarTodos() {
        String sql =
            "select p.codigo, p.data, c.nome, pr.descricao, pr.preco from pedido p " + "	join cliente c" + "	join itens_pedido i" + "	join produto pr" + "	on p.cliente_cod = c.codigo" + "	and p.codigo = i.pedido_cod" + "	and pr.codigo = i.produto_cod";
